    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body p-0">
                <div style=" position:relative; height: 400px;background-image: url(https://www.gmm-tv.com/cms/upload_file/vj_floating/pic/adda67ee0faafc8a4a9e6f88de9a0e3f.jpg);background-size: cover;">
                ...
                <div style="position:absolute; width:100%; bottom:0;color:white;background: rgb(0,0,0);background: linear-gradient(180deg, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0.75) 50%, rgba(0,0,0) 100%);">
                        <div class="p-1" style="float:left;">
                            <p class="m-0">Bright Vachirawit</p>
                        </div>
                        <div class="p-1" style="float:right">
                            <p class="m-0">Followers:</p>
                            <p class="m-0">6800000</p>
                        </div>
                    </div>
                </div>
                <div class="container">
                    <p>Brigth Vachirawit Chivaaree</p>
                    <div class="row">
                        <p class="col-4">Years: 23</p>
                        <p class="col-4">Height: 183cm</p>
                        <p class="col-4">Weight: 73kg</p>
                    </div>
                    <p>Skills: Singer</p>
...
2300000
6800000
darapa.cho@gmm.tv.com
singer
73
183
23
Brigth Vachirawit Chivaaree
Bright Vachirawit
https://www.gmm-tv.com/cms/upload_file/vj_floating..